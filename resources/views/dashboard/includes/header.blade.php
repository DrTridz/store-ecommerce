        ...
        <div class="navbar-container content">
            <div class="collapse navbar-collapse" id="navbar-mobile">
                ...
                <span class="mr-1">مرجبا
                  ...
                  <img  style="height: 35px;" src="https://thumbs.dreamstime.com/b/businessman-icon-vector-male-avatar-profile-image-profile-businessman-icon-vector-male-avatar-profile-image-182095609.jpg" alt="avatar"><i></i></span>
                        </a>
                    ...
                    <li class="dropdown dropdown-user nav-item">
                        <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                <span class="mr-1"><i class="ficon ft-globe"> </i>{{app()->getLocale()}}
                  <span
                    ...
                    <li class="dropdown dropdown-notification nav-item">
                        ...
                        <span class="badge badge-pill badge-default badge-warning badge-default badge-up badge-glow">4</span>
